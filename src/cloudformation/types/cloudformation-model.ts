...
export type ObjectOfString = { [key: string]: StringType };
 ...
 */
export type ConditionExpression = string | boolean | FnIf | FnNot | FnAnd | FnOr | FnEquals | Ref | FnContains | AnyMap;
...
export interface Statement {
    ...
    Effect: string;
    Principal?: Principal;
    Resource?: string | AnyMap | IntrinsicFunction;
    Condition?: AnyMap;
    Sid?: string;
}
...
export interface Principal {
    ...
    AWS?: string | AnyMap | IntrinsicFunction;
}
...
/**
 * Represents a generic AWS CloudFormation resource.
 *
 * This interface serves as the baseline for all CloudFormation resources.
 ...
 */
export interface PolicyDocument extends AnyMap {
    Version?: string;
    Id?: string;
    Statement?: Statement[];
}
...
export interface IAMRoleResource extends CommonResource {
    Type: 'AWS::IAM::Role';
    Properties: {
        AssumeRolePolicyDocument: PolicyDocument | AnyMap;
...
export interface IAMPolicyResource extends CommonResource {
    ...
    Properties: {
        Groups?: StringType[];
        PolicyDocument: PolicyDocument | AnyMap;
        PolicyName: string;
        Roles?: StringType[];
        Users?: StringType[];
        [propertyName: string]: unknown;
...
export interface SQSQueueResource extends CommonResource {
    ...
    Properties: {
        ...
        RedriveAllowPolicy?: AnyMap;
        RedrivePolicy?: AnyMap;
...
export interface SNSTopicResource extends CommonResource {
    Type: 'AWS::SNS::Topic';
    Properties: {
        ArchivePolicy?: AnyMap;
        ContentBasedDeduplication?: boolean;
        DataProtectionPolicy?: AnyMap;
 ...
 */
export interface LogGroupResource extends CommonResource {
    Type: 'AWS::Logs::LogGroup';
    Properties: {
        DataProtectionPolicy?: AnyMap;
        FieldIndexPolicies?: AnyMap[];
        KmsKeyId?: StringType;
...
export interface ApiGatewayDeploymentResourceStageDescriptionCanarySetting {
    PercentTraffic?: number;
    StageVariableOverrides?: ObjectOfString;
    UseStageCache?: boolean;
}
...
export interface ApiGatewayV2StageResource extends CommonResource {
    ...
    Properties: {
        ...
        DeploymentId?: StringType;
        Description?: StringType;
        RouteSettings?: ObjectOfString;
        StageName: StringType;
        StageVariables?: ObjectOfString;
        Tags?: Tag[];
        [propertyName: string]: unknown;
    };
    Metadata?: CdkMetadata;
...
export interface ApiGatewayMethodResourceIntegrationIntegrationResponses {
    ...
    ResponseParameters?: ObjectOfString;
    ResponseTemplates?: ObjectOfString;
...
export interface ApiGatewayMethodResourceIntegration {
    ...
    RequestParameters?: ObjectOfString;
    RequestTemplates?: ObjectOfString;
 ...
 */
export interface EventBusResource extends CommonResource {
...
export interface EventsRuleResourceTargetHttpParameters {
    HeaderParameters?: ObjectOfString;
    PathParameterValues?: StringType[];
    QueryStringParameters?: ObjectOfString;
}
 ...
 */
export interface ArchiveResource extends CommonResource {
 ...
 */
export interface EventBusPolicyResource extends CommonResource {
...
export interface DockerVolumeConfiguration {
    ...
    Driver?: StringType;
    DriverOpts?: ObjectOfString;
    Labels?: ObjectOfString;
    Scope?: StringType;
}
 ...
 */
export interface AWSECSTaskDefinition extends CommonResource {
...
export interface AuthenticateCognitoConfig {
    AuthenticationRequestExtraParams?: ObjectOfString;
 ...
 */
export interface AWSElasticLoadBalancingV2ListenerRule extends CommonResource {
...
export interface StepFunctionsStateMachineResource extends CommonResource {
    ...
    Properties: {
        ...
        DefinitionSubstitutions?: ObjectOfString;
 ...
 */
export interface AwsS3BucketResource extends CommonResource {
    Type: 'AWS::S3::Bucket';
    Properties: {
