import { EventsRuleResource } from '../../types/cloudformation-model';
import { IntrinsicContext } from '../../types/intrinsic-types';
import { BaseResource } from './BaseResourceImpl';

export class AwsEventsRuleResource extends BaseResource {
    ...
    override arnGenFunc(context: IntrinsicContext): string {
        ...
        if (!resource._arn) {
            ...
            const ruleName = this.idGenFunc(context);
    ...
    override idGenFunc(context: IntrinsicContext): string {
        ...
        if (!resource._id) {
            ...
            resource._id = this.resourceUtils.generateNameId(resTyped.Properties.Name, `${logicalId}.Properties.Name`, 'rule', ctx, valueResolver, 5);
        }
        return resource._id;
    }
}
